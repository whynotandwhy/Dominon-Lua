...
function onSave()
        ...
        if Use('BlackMarket')then
            ...
            while not cleanDeck do
                ...
                for i, v in ipairs(deck.getObjects())do
                    local tp=getType(v.getName()) if tp=='Event'or tp=='Landmark'or tp=='Project'or tp=='Way'then
                        coroutine.yield(0)
        ...
        if requireBane then
            ...
            if not baneSet then
                for j, card in ipairs(deck.getObjects())do
                    if getType(card.getName())=='Event'or getType(card.getName())=='Landmark'or getType(card.getName())=='Project'or getType(card.getName())=='Way'then
  ...
  {cost='MXDXP0',type='Landmark',name='Defiled Shrine',depend='VP',setup=function(o)local t=getType(o.getObjects()[1].getName());if t:find('Action')and not t:find('Gathering')then tokenMake(o,'vp',2)end end},
  ...
  {cost='MXDXP0',type='Landmark',name='Obelisk',VP=function(t)if obeliskTarget=='Knights'then return t.knights*2 elseif obeliskTarget then return(t.deck[obeliskTarget]or 0)*2 end return 0 end,setup=function(o)if getType(o.getObjects()[o.getQuantity()].getName()):find('Action')then table.insert(obeliskPiles,o)end end},
